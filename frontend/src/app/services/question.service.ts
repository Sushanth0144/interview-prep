    ...
    topics: [
      {
        ...
        questions: [
          ...
          'How does the meta tag enhance web page functionality?',
          'What is the difference between <div> and <section>?',
          'How do you create an HTML form?',
          'What is the role of the viewport meta tag?',
          'Explain the HTML5 data-* attributes.',
          ...
          'Explain the role of ARIA attributes.',
          'What is the difference between <strong> and <b>?',
          'How do you embed a video in HTML5?',
          'What is the purpose of the <figure> element?',
          'How does the <picture> element improve responsive design?',
          'What are void elements in HTML?',
          'Explain the role of the lang attribute.',
          'What is the difference between id and class attributes?',
          'How do you create a nested list in HTML?',
          'What is the purpose of the <meta charset="UTF-8"> tag?',
          'How does the <details> element work?',
          'What is the role of the <link> tag?',
          'Explain the difference between <script> async and defer.',
          'What is the purpose of the <nav> element?',
          'How do you create a table in HTML?',
          'What is the difference between <em> and <i>?',
          'How does the <progress> element work?',
          'What is the role of the <header> element?',
          'Explain the concept of HTML microdata.',
          ...
          'What is the role of the <aside> element?',
          'Explain the difference between <input> types.',
          ...
          'Explain the concept of HTML5 APIs.',
      ...
      },
      {
        ...
        questions: [
          ...
          'Explain the Flexbox layout model.',
          'What is the purpose of the calc() function?',
          'How do you center an element horizontally and vertically?',
          'What are CSS media queries?',
          'Explain the Grid layout model.',
          'What is the purpose of the :hover pseudo-class?',
          'How does the box-sizing property work?',
          'What are CSS transitions?',
          'Explain the difference between visibility and display properties.',
          'What is the purpose of the transform property?',
          'How do you create a responsive design with CSS?',
          ...
          'Explain the role of the clip-path property.',
          'What is the purpose of the object-fit property?',
          'How do you handle browser compatibility in CSS?',
          'What are CSS pseudo-elements?',
          'Explain the concept of the CSS cascade.',
          'What is the purpose of the will-change property?',
          'How do you create a sticky element in CSS?',
          'What is the difference between static and fixed positioning?',
          'Explain the role of the aspect-ratio property.',
          ...
          'What is the purpose of the @media rule?',
          'How do you create a CSS triangle?',
          'What is the role of the overflow property?',
          'Explain the difference between inline-flex and flex.',
          'What is the purpose of the gap property in Flexbox/Grid?',
          'How do you create a CSS tooltip?',
          'What is the difference between min-width and max-width?',
          'Explain the role of the content property in pseudo-elements.',
          'What is the purpose of the backdrop-filter property?',
          'How do you create a CSS shadow effect?',
          'What is the difference between justify-content and align-items?',
          'Explain the concept of CSS custom fonts.',
      ...
      },
      {
        ...
        questions: [
          ...
          'What is the purpose of the Promise object?',
          ...
          'How does the rest parameter work in JavaScript?',
          'What is the difference between forEach and map?',
          'Explain the concept of JavaScript promises chaining.',
          'What is the purpose of the Array.prototype.filter method?',
          'How do you handle cross-browser compatibility in JavaScript?',
          'What is the difference between a function declaration and expression?',
          'Explain the concept of event bubbling.',
          'What is the purpose of the localStorage API?',
          ...
          'How do you create a JavaScript generator function?',
          'What is the difference between Object.keys and Object.entries?',
          'Explain the concept of JavaScript IIFE.',
          ...
          'Explain the concept of JavaScript event listeners.',
        ]
      },
      {
        name: 'Angular',
        questions: [
          ...
          'Explain the component-based architecture in Angular.',
          ...
          'What is Angular Material and its benefits?',
          'Explain the concept of change detection in Angular.',
          'What is the purpose of the Renderer2 class?',
          'How do you handle forms validation in Angular?',
          'What are Angular pipes? Give examples.',
          'Explain the difference between AOT and JIT compilation.',
          'What is the role of the ActivatedRoute service?',
          'How do you create a custom pipe in Angular?',
          'What is the purpose of the NgZone service?',
          'Explain the concept of RxJS in Angular.',
          'What is the difference between ViewChild and ContentChild?',
          'How do you implement dynamic components in Angular?',
          'What is the purpose of the RouterOutlet directive?',
          'Explain the concept of Angular modules.',
          'What is the role of the @NgModule decorator?',
          ...
          'What is the difference between providedIn: "root" and other providers?',
          'How do you optimize Angular application performance?',
          'What is the purpose of the ViewEncapsulation property?',
          'How do you implement state management in Angular?',
          'What is the difference between CanActivate and CanDeactivate guards?',
          'Explain the concept of Angular animations.',
          'What is the purpose of the ChangeDetectorRef service?',
          'How do you create a reusable component in Angular?',
          'What is the role of the ElementRef class?',
          'Explain the concept of Angular template syntax.',
          'What is the purpose of the NgIf directive?',
          'How do you handle cross-component communication in Angular?',
          'What is the difference between structural and attribute directives?',
          'Explain the concept of Angular CLI.',
          'What is the purpose of the APP_INITIALIZER token?',
